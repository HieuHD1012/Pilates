# API: Đổi HLV của một buổi lớp. Từ chối nếu HLV mới trùng giờ dạy
...
- **Purpose:** Đổi HLV của một buổi lớp. Từ chối nếu HLV mới trùng giờ dạy.
- **Method:** `POST`
- **Endpoint:** `/classes/{session_id}/trainer`
