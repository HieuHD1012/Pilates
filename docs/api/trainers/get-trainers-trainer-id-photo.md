# API: Ảnh đại diện HLV dạng nhị phân. Trả 404 kèm mã `NO_PHOTO` khi chưa có ảnh
...
- **Purpose:** Ảnh đại diện HLV dạng nhị phân. Trả 404 kèm mã `NO_PHOTO` khi chưa có ảnh.
- **Method:** `GET`
