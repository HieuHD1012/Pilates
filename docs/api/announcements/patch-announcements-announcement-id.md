# API: Sửa thông báo. Nội dung được lọc lại qua whitelist HTML
...
- **Purpose:** Sửa thông báo. Nội dung được lọc lại qua whitelist HTML.
- **Method:** `PATCH`
- **Endpoint:** `/announcements/{announcement_id}`
...
|---|---|---|---|
| title | string \| null | Không | tối thiểu 1 ký tự; tối đa 200 ký tự |
| body | string \| null | Không | tối thiểu 1 ký tự; tối đa 10000 ký tự |
